...
class WebhookEvent(PaypalModel):
    ...
    resource_version = models.CharField(max_length=8, blank=True, editable=False)
    ...
    def resource_model(self):
        ...
        elif resource_type == 'capture':
            from .orders import Capture
            return Capture
